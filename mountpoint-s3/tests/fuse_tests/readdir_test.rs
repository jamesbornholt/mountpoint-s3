use crate::fuse_tests::{read_dir_to_entry_names, SessionCreator, TestClientBox, TestSessionConfig};
...
fn readdir(creator_fn: SessionCreator, prefix: &str, rng_seed: usize) {
    let readdir_size = 5;
...
fn readdir_while_writing(creator_fn: SessionCreator, prefix: &str, rng_seed: usize) {
    let readdir_size = 5;
    let filesystem_config = S3FilesystemConfig {
        readdir_size,
        ..Default::default()
